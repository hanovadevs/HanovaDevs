...
const initialFeaturedProjects = [
  ...
  },
  {
    ...
    thumbnail: '/projects/earthsync.webp',
    theme: 'light',
  ...
  },
  {
    ...
    thumbnail: '/projects/terrasol.webp',
    theme: 'terrasol',
  ...
  },
  {
    ...
    thumbnail: '/projects/lumiere.webp',
    theme: 'lumiere',
  ...
  },
  {
    ...
    thumbnail: '/projects/codator.webp',
    theme: 'codator',
        ...
        if (fetched && fetched.length > 0) {
          ...
          const normalized = validFetched.map(item => {
            ...
            return {
              ...
              thumbnail: defaultMatch?.thumbnail || item.image_url || item.thumbnail || '/projects/raqs.webp',
